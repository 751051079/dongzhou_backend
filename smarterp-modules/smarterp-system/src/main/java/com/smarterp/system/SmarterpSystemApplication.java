...
@EnableScheduling
public class SmarterpSystemApplication
{
    public static void main(String[] args)
    {
        SpringApplication.run(SmarterpSystemApplication.class, args);
        System.out.println("(♥◠‿◠)ﾉﾞ  ERP系统模块启动成功   ლ(´ڡ`ლ)ﾞ  \n" +
                " .-------.       ____     __        \n" +
                " |  _ _   \\      \\   \\   /  /    \n" +
                " | ( ' )  |       \\  _. /  '       \n" +
                " |(_ o _) /        _( )_ .'         \n" +
